...
from src.dataset_getters import get_physionet_labels, get_physionet_audio_dir_path, get_physionet_label, \
    get_kaggle_audio_dir_path, get_kaggle_label, get_kaggle_labels_path, map_kaggle_label_to_number
...
def add_kaggle_dataset_to_csv(kaggle_labels):
...
def add_row(data_dir_path, signal_filename, label):
...
if __name__ == '__main__':
    ...
    physionet_labels = get_physionet_labels()
    ...
    with open(dataset_path, 'a') as dataset_file:
        ...
        add_physionet_dataset_to_csv(physionet_labels)
        add_kaggle_dataset_to_csv(kaggle_a_labels)
